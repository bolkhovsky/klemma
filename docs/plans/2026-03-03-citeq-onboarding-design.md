# Klemma Onboarding: два режима инициализации проекта

> Design document. Реализация — при старте SaaS-спринта.

## Контекст

Klemma SaaS требует лёгкий онбординг, который максимально быстро показывает ценность продукта. Два типичных сценария пользователя:
