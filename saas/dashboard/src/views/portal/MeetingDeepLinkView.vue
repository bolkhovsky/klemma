...
/**
 * `/m/:sourceId` — стабильная внешняя ссылка на одну встречу.
 *
 * Путь именно `/m/`, а не `/meetings/`: в самодостаточном контейнере портала
 * (KLEMMA_SERVE_SPA) FastAPI сперва матчит собственный роутер `/meetings`, и
 * браузер получает 401 JSON вместо SPA.
 *
