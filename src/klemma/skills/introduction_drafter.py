...
def generate_introduction(
    ...
    *,
    ...
    system = (
        "Ты — генератор текста для кандидатских диссертаций. "
        "Твоя единственная задача — сгенерировать текст секций введения. "
        "НЕ задавай вопросов, НЕ предлагай план, НЕ проси подтверждения. "
        "Сразу выдай готовый текст в формате markdown на русском научном языке."
    )
